...
_MATERIALS_SEED = [
    # (code, name, spec, unit, cumulative_usage, remaining_quantity)
    # received_quantity is auto-computed as cumulative + remaining
    ('01-01-012N', '防脫塑用伸縮止水栓附表由令', '13mm', '只', '18', '9'),
    ('01-01-013N', '防脫塑用伸縮止水栓附表由令', '20mm', '只', '34', '31'),
    ('01-01-014N', '防脫塑用伸縮止水栓附表由令', '25mm', '只', '28', '7'),
    ('01-01-015N', '防脫塑用伸縮止水栓附表由令', '40mm', '只', '12', '7'),
    ('01-01-029',  '鐵用表由令', '13mm', '只', '23', '0'),
    ('01-01-030',  '鐵用表由令', '20mm', '只', '35', '0'),
    ('01-01-031',  '鐵用表由令', '25mm', '只', '25', '10'),
    ('01-01-032',  '鐵用表由令', '40mm', '只', '10', '0'),
    ('01-01-033',  '鉛塑由令', '13mm', '只', '4', '0'),
    ('01-01-034',  '鉛塑由令', '20mm', '只', '3', '0'),
    ('01-01-035',  '鉛塑由令', '25mm', '只', '2', '2'),
    ('01-01-090',  '水量計異徑接頭', '20mmX13mm(每組2只)', '組', '15', '0'),
    ('01-01-091',  '水量計異徑接頭', '25mmX20mm(每組2只)', '組', '40', '0'),
    ('01-01-092',  '水量計異徑接頭', '40mmX25mm(每組2只)', '組', '40', '0'),
    ('01-03-337',  '延性水表箱(附活動拉桿)', '小型', '只', '1', '1'),
    ('01-04-081',  '不鏽鋼管用伸縮止水栓（球型閥）', '40mm', '只', '1', '0'),
    ('02-01-114',  '塑膠閥接頭', '13(CNS16)mm', '只', '2', '0'),
    ('02-01-115',  '塑膠閥接頭', '20mm', '只', '30', '0'),
    ('02-01-136',  '塑膠球型閥', '13(CNS16)mm', '只', '10', '0'),
    ('02-01-137',  '塑膠球型閥', '20mm', '只', '22', '8'),
    ('02-01-138',  '塑膠球型閥', '25mm', '只', '20', '0'),
    ('02-01-139',  '塑膠球型閥', '40mm', '只', '2', '8'),
    ('02-05-001',  '耐衝擊塑膠管', '13(CNS16)mmX4M', 'M', '8', '0'),
    ('02-05-002',  '耐衝擊塑膠管', '20mmX4m', 'M', '40', '0'),
    ('02-05-003',  '耐衝擊塑膠管', '25mmX4m', 'M', '40', '0'),
    ('02-05-019',  '耐衝擊塑膠彎頭', '13(CNS16)mmx90°', '只', '20', '0'),
    ('02-05-020',  '耐衝擊塑膠彎頭', '20mmX90°', '只', '50', '0'),
    ('02-05-021',  '耐衝擊塑膠彎頭', '25mmX90°', '只', '30', '0'),
    ('02-05-022',  '耐衝擊塑膠彎頭', '40mmX90°', '只', '10', '0'),
    ('02-05-116',  '耐衝擊塑膠閥接頭', '25mm', '只', '9', '6'),
    ('02-05-117',  '耐衝擊塑膠閥接頭', '40mm', '只', '5', '5'),
    ('02-05-146',  '耐衝擊塑膠管用膠合劑', '100公克/罐', '公克', '1000', '0'),
    ('05-05-001',  '封印線', '3股(不銹鋼線)', '公斤', '57.198', '0'),
    ('05-08-001',  '鉛封子', '', '只', '57198', '0'),
    ('06-01-001',  '水表用墊圈', '13mm', '只', '1000', '0'),
    ('06-01-002',  '水表用墊圈', '20mm', '只', '1700', '0'),
    ('06-01-003',  '水表用墊圈', '25mm', '只', '4700', '0'),
    ('06-01-004',  '水表用墊圈', '40mm', '只', '1500', '0'),
    ('07-01-001',  '新表-螺紋式', '13mm', '只', '1929', '0'),
    ('07-01-002',  '新表-螺紋式', '20mm', '只', '24980', '2'),
    ('07-01-003',  '新表-螺紋式', '25mm', '只', '26827', '3'),
    ('07-01-004',  '新表-螺紋式', '40mm', '只', '1949', '1'),
    ('07-01-015',  '新表-螺紋式', '50mm', '只', '3', '0'),
    ('07-01-805',  '新表-螺旋電子式(不含短管及遠隔顯示配件)', '50mm(保固8年,奧多曼式橫軸)', '只', '29', '0'),
    ('07-01-806',  '新表-螺旋電子式(不含短管及遠隔顯示配件)', '75mm(保固8年,奧多曼式橫軸)', '只', '38', '0'),
    ('07-01-807',  '新表-螺旋電子式(不含短管及遠隔顯示配件)', '100mm(保固8年,奧多曼式橫軸)', '只', '11', '0'),
    ('07-01-808',  '新表-螺旋電子式(不含短管及遠隔顯示配件)', '150mm(保固8年,奧多曼式橫軸)', '只', '1', '0'),
    ('07-01-8242', '自動讀表用水量計(2024年購案)', '20mm(保固8年)', '只', '117', '0'),
    ('07-01-8243', '自動讀表用水量計(2024年購案)', '25mm(保固8年)', '只', '32', '0'),
    ('07-01-8244', '自動讀表用水量計(2024年購案)', '40mm(保固8年)', '只', '11', '0'),
    ('07-06-001',  '堪用表-螺紋式', '13mm', '只', '1', '0'),
    ('07-06-002',  '堪用表-螺紋式', '20mm', '只', '441', '0'),
    ('07-06-003',  '堪用表-螺紋式', '25mm', '只', '635', '0'),
    ('07-06-015',  '堪用表-螺紋式', '50mm', '只', '1', '0'),
    ('07-06-021',  '堪用表-螺紋電子式', '13mm', '只', '9', '0'),
    ('07-06-021A', '堪用表-螺紋電子式(專案用表)', '13mm', '只', '3', '0'),
    ('07-06-022A', '堪用表-螺紋電子式(專案用表)', '20mm', '只', '22', '0'),
    ('07-06-023',  '堪用表-螺紋電子式', '25mm', '只', '1', '0'),
    ('07-06-023A', '堪用表-螺紋電子式(專案用表)', '25mm', '只', '18', '0'),
    ('07-06-024',  '堪用表-螺紋電子式', '40mm', '只', '30', '0'),
    ('07-06-024A', '堪用表-螺紋電子式(專案用表)', '40mm', '只', '2', '0'),
    ('07-06-125',  '堪用表-螺旋電子式(含遠隔顯示器及配線等)', '50mm(奧多曼式橫軸)', '只', '1', '0'),
    ('07-06-2023', '堪用表-109年營運測試用表(項次2)', '25mm', '只', '14', '0'),
    ('07-06-2034', '堪用表-109年營運測試用表(項次3)', '40mm', '只', '1', '1'),
    ('07-06-2053', '堪用表-109年營運測試用表(項次5)', '25mm', '只', '1', '0'),
    ('07-06-2062', '堪用表-109年營運測試用表(項次6)', '20mm', '只', '38', '0'),
    ('07-06-2063', '堪用表-109年營運測試用表(項次6)', '25mm', '只', '5', '0'),
    ('07-06-2064', '堪用表-109年營運測試用表(項次6)', '40mm', '只', '1', '0'),
    ('07-06-2073', '堪用表-109年營運測試用表(項次7)', '25mm', '只', '4', '0'),
    ('07-06-805',  '堪用表-螺旋電子式(不含短管及遠隔顯示配件)', '50mm(保固8年,奧多曼式橫軸)', '只', '1', '0'),
    ('07-06-806',  '堪用表-螺旋電子式(不含短管及遠隔顯示配件)', '75mm(保固8年,奧多曼式橫軸)', '只', '1', '0'),
    ('07-06-807',  '堪用表-螺旋電子式(不含短管及遠隔顯示配件)', '100mm(保固8年,奧多曼式橫軸)', '只', '1', '0'),
    ('07-06-818',  '堪用表-螺紋電子式', '50mm(保固8年)', '只', '1', '0'),
    ('07-06-8202', '堪用表-自動讀表用水量計', '20mm(保固8年)', '只', '7', '0'),
    ('07-06-8203', '堪用表-自動讀表用水量計', '25mm(保固8年)', '只', '8', '0'),
    ('07-06-8204', '堪用表-自動讀表用水量計', '40mm(保固8年)', '只', '6', '0'),
    ('07-06-822',  '堪用表-螺紋電子式', '20mm(保固8年)', '只', '1', '0'),
    ('07-06-8223', '堪用表-自動讀表用水量計(2022年購案)', '25mm(保固8年)', '只', '1', '0'),
    ('07-06-8224', '堪用表-自動讀表用水量計(2022年購案)', '40mm(保固8年)', '只', '2', '0'),
    ('07-06-8244', '堪用表-自動讀表用水量計(2024年購案)', '40mm(保固8年)', '只', '1', '0'),
    ('07-06-842',  '堪用表-20mm計量單元', '20mm(保固8年)', '只', '122', '0'),
    ('07-06-843',  '堪用表-25mm計量單元', '25mm(保固8年)', '只', '18', '0'),
    ('07-06-862',  '堪用表-20mm計量單元及訊號傳輸模組(4G含以上)', '20mm(保固8年)', '組', '1', '0'),
    ('07-06-863',  '堪用表-25mm計量單元及訊號傳輸模組(4G含以上)', '25mm(保固8年)', '組', '3', '0'),
    ('07-06-864',  '堪用表-40mm計量單元及訊號傳輸模組(4G含以上)', '40mm(保固8年)', '組', '5', '0'),
]
...
def _seed_materials_csv(reset=False):
    ...
    if reset:
        ...
        db.session.commit()
    for i, (code, name, spec, unit, cu, stock) in enumerate(_MATERIALS_SEED):
